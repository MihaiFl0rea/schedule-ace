 ...
 */
    ...
    // admin module paths
    defined('ADMIN_AUTH_PATH') ? null : define('ADMIN_AUTH_PATH', SITE_ROOT.DS.'admin'.DS.'index.php?m=authentication');
    defined('ADMIN_HOME_PATH') ? null : define('ADMIN_HOME_PATH', SITE_ROOT.DS.'admin'.DS.'index.php?m=home');
